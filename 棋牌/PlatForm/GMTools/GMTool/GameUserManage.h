...
public:
	...
	int GetDeskUserCount(int iDeskIndex);
	int GetDeskPlayCount(int iDeskIndex);

	int GetIndexByUserID(int dwUserID);
...
public:
	...
	//查找用户
	virtual UserItemStruct * FindOnLineUser(BYTE bDeskIndex, BYTE bDeskStation);
};
