...
#ifndef CAFCWEB_HEAD_FILE
#define CAFCWEB_HEAD_FILE

#include "PublicDefine.h"

//‰Ø¿¿∆˜ ”Õº
class EXT_CLASS CIEClass/*CIEClass*/ : public CWnd
{
protected:
	DECLARE_DYNCREATE(CIEClass)
...
public:
	void GoBack()
	{
		try{InvokeHelper(0x64, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);}catch(...){}
	}
	void GoForward()
	{
		try{InvokeHelper(0x65, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);}catch(...){}
	}
	void GoHome()
	{
