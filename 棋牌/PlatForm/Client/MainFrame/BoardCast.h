...
// 对话框数据
	...
	CconfigDlg  m_configDlg1; //道具功能界面 加载底图类. 2012.10.16 yyf
	CconfigDlg  m_configDlg2; //大喇叭界面 加载底图类. 2012.10.16 yyf
	CconfigDlg  m_configDlg3; //小喇叭界面 加载底图类. 2012.10.16 yyf
public:
