...
//#define IPC_MAIN_CONFIGX				0x531							//小猪快跑数据发送

#define		IPC_SUB_SERVER_INFO				1								//房间信息
#define		IPC_SUB_ENCRYPT_TYPE			2								//加密方式
...
#define	IPC_USER_PROP_RESULT			13								//道具操作结果信息
...
#define     IPC_SUB_ACTIVE_TO_ROOM          8

#define     IPC_SUB_SCREEN_SIZE_CHANGE      9							//游戏窗口改变屏幕分辨率
...
#define		IPC_SUB_GAMEFRAME_INITED		6								//游戏框架装载完成
...
#define		IPC_SUB_BUY_PROP_NEW			11

//道具界面购买VIP消息  add by wyl 11-5-21
#define		IPC_PROP_BUY_VIP				14								
#define		IPC_ASS_BUY_VIP					1								
#define		IPC_ASS_GIVE_VIP				2	

#define		IPC_FRIEND						15	                       // 加为好友							
#define		IPC_ASS_CHECKFRIEND				1								
#define		IPC_ASS_ADDFRIEND				2	
#define		IPC_ASS_GETFRIENDLIST			3

// duanxiaohui 2011-11-11 加入黑名单消息
#define     IPC_EMENY                       16                               // 黑名单消息
#define     IPC_ASS_CHECKEMENY              1                                // 检查黑名单
#define     IPC_ASS_ADDEMENY                2                                // 加入黑名单
// end duanxiaohui
