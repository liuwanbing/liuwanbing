...
class CMacButton_Other : public CButton
{
...
public:
	...
	virtual ~CMacButton_Other();

	// Generated message map functions
protected:
	//{{AFX_MSG(CMacButton_Other)
...
class CMacCheckBox : public CMacButton_Other
{
...
class CMacRadioButton : public CMacButton_Other
{
...
class CMacMoreButton : public CMacButton_Other
{
// Construction
public:
	CMacMoreButton();
