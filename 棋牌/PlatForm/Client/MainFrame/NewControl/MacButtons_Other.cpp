...
/////////////////////////////////////////////////////////////////////////////
//
//	CMacButton_Other class, version 2.0
//
...
//-------------------------------------------------------------------
//
CMacButton_Other::CMacButton_Other()
//
// Return Value:	None.
//
// Parameters	:	None.
...
BEGIN_MESSAGE_MAP(CMacButton_Other, CButton)
	//{{AFX_MSG_MAP(CMacButton_Other)
...
/////////////////////////////////////////////////////////////////////////////
// CMacButton_Other message handlers

//-------------------------------------------------------------------
//
void CMacButton_Other::PreSubclassWindow() 
//
// Return Value:	None.
//
// Parameters	:	None.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DrawItem(LPDRAWITEMSTRUCT lpDIS) 
//
// Return Value:	None.
//
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DrawButton(LPDRAWITEMSTRUCT lpDIS)
//
// Return Value:	None.
//
// Parameters	:	lpDIS - A long pointer to a DRAWITEMSTRUCT structure.
...
//
{
	...
	//dcMem.FillSolidRect(rectItem, RGB(168, 166, 98));
	CBitmap img;
	img.LoadBitmap(IDB_DIALOG_BACKGROUND_OTHER);
	CDC TempDC;
	TempDC.CreateCompatibleDC(pDC);
	TempDC.SelectObject(&img);
	dcMem.BitBlt(rectItem.left, rectItem.top, rectItem.Width(),rectItem.Height(),&TempDC,0,0,SRCCOPY);
//	img.TitleDrawImage(&dcMem, rectItem.left, rectItem.top, rectItem.Width(),
//		rectItem.Height());
	
	//dcMem.BitBlt(rectItem.left, rectItem.top, rectItem.Width(), rectItem.Height(), pDC, rectItem.left, rectItem.top, SRCCOPY);
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DrawStandardButton(CDC *pDC, const CRect &rect, UINT nStyle, UINT nState)
//
// Return Value:	None.
//
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DrawCheckBox(CDC *pDC, CRect rect, UINT nStyle, UINT nState)
//
// Return Value:	None.
//
// Parameters	:	pDC - A pointer to the DC to draw on.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DrawRadioButton(CDC *pDC, CRect rect, UINT nStyle, UINT nState)
//
// Return Value:	None.
//
// Parameters	:	pDC - A pointer to the DC to draw on.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::OnLButtonDblClk(UINT /*nFlags*/, CPoint point) 
//
// Return Value:	None.
//
...
//-------------------------------------------------------------------
//
void CMacButton_Other::OnSysColorChange() 
//
// Return Value:	None.
//
// Parameters	:	None.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::GetColors()
//
// Return Value:	None.
//
// Parameters	:	None.
...
//-------------------------------------------------------------------
//
COLORREF CMacButton_Other::LightenColor(const COLORREF crColor, BYTE byIncreaseVal)
//
// Return Value:	None.
//
...
//-------------------------------------------------------------------
//
COLORREF CMacButton_Other::DarkenColor(const COLORREF crColor, BYTE byReduceVal)
//
// Return Value:	None.
//
// Parameters	:	crColor - References a COLORREF structure.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::CreatePens()
//
// Return Value:	None.
//
// Parameters	:	None.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DeletePens()
//
// Return Value:	None.
//
// Parameters	:	None.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DrawImage(CDC *pDC, CRect &rect, UINT nStyle, UINT nState)
//
// Return Value:	None.
//
// Parameters	:	pDC - A pointer to the DC to draw on.
...
//-------------------------------------------------------------------
//
HICON CMacButton_Other::SetIcon(HICON hIcon)
//
...
//-------------------------------------------------------------------
//
HBITMAP CMacButton_Other::SetBitmap(HBITMAP hBitmap)
//
...
//-------------------------------------------------------------------
//
CRect CMacButton_Other::GetCheckRect(const CRect &rect, UINT nStyle)
//
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DrawUnpressedPushButton(CDC *pDC, const CRect &rect)
//
// Return Value:	None.
//
// Parameters	:	pDC - A pointer to the DC to draw on.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DrawPressedPushButton(CDC *pDC, const CRect &rect)
//
// Return Value:	None.
//
// Parameters	:	pDC - A pointer to the DC to draw on.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DrawCornerShadows(CDC *pDC, const CRect &rect)
//
// Return Value:	None.
//
// Parameters	:	pDC - A pointer to the DC to draw on.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DrawPushLikeButton(CDC *pDC, const CRect &rect, UINT nStyle, UINT nState)
//
// Return Value:	None.
//
// Parameters	:	pDC - A pointer to the DC to draw on.
...
//-------------------------------------------------------------------
//
HBITMAP CMacButton_Other::GetDitherBitmap(CDC *pDC, COLORREF crColor1, COLORREF crColor2)
//
...
//-------------------------------------------------------------------
//
void CMacButton_Other::RedrawCheck()
//
// Return Value:	None.
//
// Parameters	:	None.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::DrawButtonText(CDC *pDC, CRect &rect, const CString &sText, UINT nStyle, UINT nState)
//
// Return Value:	None.
//
// Parameters	:	pDC - A pointer to the DC being drawn on.
...
//-------------------------------------------------------------------
//
void CMacButton_Other::SetImageEffect(int nEffect)
//
// Return Value:	None.
//
...
//-------------------------------------------------------------------
//
void CMacButton_Other::SetCheck(int nCheck)
//
// Return Value:	None.
//
...
//-------------------------------------------------------------------
//
int CMacButton_Other::GetCheck() const
//
...
//-------------------------------------------------------------------
//
void CMacButton_Other::SetBold(BOOL bBold /*= TRUE*/)
//
// Return Value:	None.
//
...
//-------------------------------------------------------------------
//
BOOL CMacButton_Other::GetBold() const
//
...
BEGIN_MESSAGE_MAP(CMacCheckBox, CMacButton_Other)
...
BEGIN_MESSAGE_MAP(CMacRadioButton, CMacButton_Other)
...
//
{
	...
	return CMacButton_Other::PreTranslateMessage(pMsg);
}	// PreTranslateMessage
...
//	CMacButton_Other::OnLButtonUp(nFlags, point);
}	// OnLButtonUp
...
//
{
	...
	if (GetStyle() & BS_PUSHLIKE)
		...
		RedrawCheck();
//	CMacButton_Other::OnLButtonDown(nFlags, point);
}	// OnLButtonDown
...
//
{
	...
	CMacButton_Other::OnMouseMove(nFlags, point);
}	// OnMouseMove
...
//
{
	CMacButton_Other::OnSysColorChange();
...
//
{
	CMacButton_Other::OnSetFocus(pOldWnd);
...
//
{
	CMacButton_Other::PreSubclassWindow();
