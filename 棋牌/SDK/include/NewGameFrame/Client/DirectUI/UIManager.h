...
public:
    ...
    static const CStdString& GetResourcePackage();
    static void SetInstance(HINSTANCE hInst);
    static void SetCurrentPath(LPCTSTR pStrPath);
    static void SetResourceDll(HINSTANCE hInst);
    static void SetResourcePath(LPCTSTR pStrPath);
    static void SetResourcePackage(LPCTSTR pStrZip,LPCTSTR pStrPassword);
	static CStdString GetPackagePassword();
...
private:
	...
	static CStdString m_pStrPassword;
    static short m_H;
    static short m_S;
    static short m_L;
