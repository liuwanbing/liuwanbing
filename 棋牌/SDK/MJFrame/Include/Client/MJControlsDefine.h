...
const int CTN_IMG_Ting_0 = 2002220;                           /// 玩家0听牌
const int CTN_IMG_Ting_1 = CTN_IMG_Ting_0 + 1;                /// 玩家1听牌
const int CTN_IMG_Ting_2 = CTN_IMG_Ting_0 + 2;                /// 玩家2听牌
const int CTN_IMG_Ting_3 = CTN_IMG_Ting_0 + 3;                /// 玩家3听牌
