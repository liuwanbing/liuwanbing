...
#define MJ_STATE_GIVE_WAIT	        9	// 出牌等待
#define MJ_STATE_NONE		        10	// 数量
...
#define MJ_TIMER_SET_GIVE           12   // 定时出牌
...
// 玩家设置旁观状态消息(主ID180, 次ID52)
#define ASS_SUB_SET_WATCH     52

// 旁观玩家消息(主ID180, 次ID53)
#define ASS_SUB_WATCH         53
...
// 旁观玩家消息结构体
struct MSG_GR_S_Watch
{
	bool    bIsWatch;           // true: 旁观玩家, false: 非旁观玩家
};

// 旁观消息结构体
struct MSG_GR_S_SetWatch
{
	bool    bEnableWatch;       // true: 允许旁观, false: 不允许旁观
};
