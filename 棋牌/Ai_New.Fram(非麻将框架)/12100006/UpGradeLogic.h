...
#define ZX_SHAN_HUA_LIU				2				//三花六
#define ZX_SHAN_HUA_SHI				1				//三花十
#define ZX_ERROR					0				//都不是花三六或花三十
//===========================================================================================
...
public:
		...
		BYTE IsThreeTenOrThreThreeSixe(BYTE byCardList[], int iCardCount);			//检测是否是三花十或花三六
//------------------------------------------------------------------------------------------------------
public:
