...
//510k牌型信息
const int i510kCardStyle[18]={UG_ONLY_ONE,UG_STRAIGHT,UG_DOUBLE,UG_TWO_DOUBLE,UG_DOUBLE_SEQUENCE,UG_THREE,UG_THREE_SEQUENCE,
...
,UG_FOUR_TWO,UG_FOUR_TWO_DOUBLE,UG_THREE_DOUBLE_SEQUENCE};
//扑克分析结构	（只用于服务器对比扑克）
