...
void CGameSet::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_CHECK_TALKSOUND, m_check_6);
}
...
void CGameSet::OnOK()
{
	...
	m_bEnableTalkSound = (m_check_6.GetCheck()==BST_CHECKED);
...
BOOL CGameSet::OnInitDialog()
{
	...
	if (m_bEnableTalkSound) m_check_6.SetCheck(BST_CHECKED);
