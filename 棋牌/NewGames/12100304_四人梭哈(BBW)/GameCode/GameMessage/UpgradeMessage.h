...
#ifdef  SSYJ //谁是赢家
#define CLIENT_DLL_NAME					TEXT("12100304.ico")
#define SERVER_DLL_NAME					TEXT("12100304.DLL")
#define NAME_ID							12100304							//名字 ID
#define PLAY_COUNT						4							//游戏人数
