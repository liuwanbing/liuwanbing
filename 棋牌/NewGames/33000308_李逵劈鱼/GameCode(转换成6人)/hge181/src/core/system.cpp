...
bool CALL HGE_Impl::System_Start()
{
	...
	OutputDebugString("hge:System_Start 1");

	if(!hwnd)
	{
		_PostError("hge:System_Start: System_Initiate wasn't called");
		return false;
	}

	OutputDebugString("hge:System_Start 2");
	...
	OutputDebugString("hge:System_Start 3");
	...
	for(;;)
	{
		...
		OutputDebugString("hge:for System_Start 3");
		...
		OutputDebugString("hge:for System_Start 4");
		...
		OutputDebugString("hge:for System_Start 5");
		...
		if(bActive || bDontSuspend)
		{
			...
			if(dt >= nFixedDelta)
			{
				OutputDebugString("hge:for System_Start 6");
				...
				OutputDebugString("hge:for System_Start 7");

				// Do user's stuff

				if(procFrameFunc()) 
				{
					OutputDebugString("hge:for System_Start 8");
					break;
				}
				...
				OutputDebugString("hge:for System_Start 9");
			...
			{
				OutputDebugString("hge:for System_Start 10");
	...
	OutputDebugString("hge:System_Start 4");

	_ClearQueue();

	OutputDebugString("hge:System_Start 5");

	bActive=false;

	OutputDebugString("hge:System_Start 6");
