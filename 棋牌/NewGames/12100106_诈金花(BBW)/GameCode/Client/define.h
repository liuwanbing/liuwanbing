...
const int CTN_1000000_CTN_1003126_BTN_1003030 = 1003030;  ///<换  按扭 resources\image\bi_bt.png
...
const int CTN_1000000_CTN_100210702 = 100210702;  ///<超端  容器 
const int CTN_1000000_CTN_100210702_RButton_100210703 = 100210703;  ///<单选框赢1  单选框 
const int CTN_1000000_CTN_100210702_RButton_100210704 = 100210704;  ///<单选框赢2  单选框 
const int CTN_1000000_CTN_100210702_RButton_100210705 = 100210705;  ///<单选框赢3  单选框 
const int CTN_1000000_CTN_100210702_RButton_100210706 = 100210706;  ///<单选框赢4  单选框 
const int CTN_1000000_CTN_100210702_RButton_100210707 = 100210707;  ///<单选框赢5  单选框 
const int CTN_1000000_CTN_100210702_RButton_100210708 = 100210708;  ///<单选框赢6  单选框 
const int CTN_1000000_CTN_100210702_RButton_100210709 = 100210709;  ///<单选框输1  单选框 
const int CTN_1000000_CTN_100210702_RButton_100210710 = 100210710;  ///<单选框输2  单选框 
const int CTN_1000000_CTN_100210702_RButton_100210711 = 100210711;  ///<单选框输3  单选框 
const int CTN_1000000_CTN_100210702_RButton_100210712 = 100210712;  ///<单选框输4  单选框 
const int CTN_1000000_CTN_100210702_RButton_100210713 = 100210713;  ///<单选框输5  单选框 
const int CTN_1000000_CTN_100210702_RButton_100210714 = 100210714;  ///<单选框输6  单选框 
const int CTN_1000000_CTN_100210702_TEXT_100210715 = 100210715;  ///<1号位  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210716 = 100210716;  ///<2号位  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210717 = 100210717;  ///<3号位  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210718 = 100210718;  ///<4号位  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210719 = 100210719;  ///<5号位  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210720 = 100210720;  ///<6号位  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210721 = 100210721;  ///<赢  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210722 = 100210722;  ///<赢  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210723 = 100210723;  ///<赢  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210724 = 100210724;  ///<赢  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210725 = 100210725;  ///<赢  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210726 = 100210726;  ///<赢  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210727 = 100210727;  ///<输  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210728 = 100210728;  ///<输  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210729 = 100210729;  ///<输  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210730 = 100210730;  ///<输  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210731 = 100210731;  ///<输  静态文本 
const int CTN_1000000_CTN_100210702_TEXT_100210732 = 100210732;  ///<输  静态文本 
const int CTN_1000000_CTN_100210702_BTN_100210733 = 100210733;  ///<确定  按扭 resources\image\确定.png
const int CTN_1000000_CTN_100210702_BTN_100210734 = 100210734;  ///<取消  按扭 resources\image\取消.png



const int CTN_1000000_CTN_100200 = 100200;  ///<换牌容器  容器 

const int CTN_1000000_CTN_100200_CTN_100210 = 100210;  ///<提示容器  容器 
const int CTN_1000000_CTN_100200_CTN_100210_TEXT_10021001 = 10021001;  ///<提示  静态文本 
const int CTN_1000000_CTN_100200_CTN_100210_TEXT_10021002 = 10021002;  ///<提示信息  静态文本 
const int CTN_1000000_CTN_100200_CTN_100210_BTN_10021011 = 10021011;  ///<确定  按扭 resources\image\B_qd.png
const int CTN_1000000_CTN_100200_CTN_100210_BTN_10021012 = 10021012;  ///<取消  按扭 resources\image\B_qx.png
const int CTN_1000000_CTN_100200_TEXT_10020002 = 10020002;  ///<提示文字  静态文本 
const int CTN_1000000_CTN_100200_BTN_10020003 = 10020003;  ///<确定  按扭 resources\image\B_qd.png
const int CTN_1000000_CTN_100200_BTN_10020004 = 10020004;  ///<取消  按扭 resources\image\B_qx.png
const int CTN_1000000_CTN_100200_OperateCard_10020001 = 10020001;  ///<可操作的牌控件1  自己牌控件 